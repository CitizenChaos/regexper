  ...
  _.forIn(
    ...
    (content, str) => {
      it(`parses "${str}" as a Root`, function () {
        ...
        expect(parser.__consume__root()).toEqual(
  ...
  describe('#_render', function () {
    ...
    describe('when there are flags', function () {
      ...
      it('renders a text element', function () {
        ...
        expect(this.node.container.text).toHaveBeenCalledWith(
          0,
          0,
          'Flags: example, flags'
        )
      ...
      describe('when there are flags', function () {
        ...
        it('moves the regexp below the flag text', function (done) {
          this.node
            ._render()
            .then(() => {
              expect(this.node.regexp.transform).toHaveBeenCalledWith(
                Snap.matrix().translate(10, 20)
              )
              done()
            })
            .catch(done.fail)
